...
module lab9_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> aes_s1_agent:cp_valid
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> aes_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // aes_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> aes_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> aes_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> aes_s1_agent:cp_endofpacket
	...
	wire          aes_s1_agent_rp_valid;                                                              // aes_s1_agent:rp_valid -> router_007:sink_valid
	wire  [104:0] aes_s1_agent_rp_data;                                                               // aes_s1_agent:rp_data -> router_007:sink_data
	wire          aes_s1_agent_rp_ready;                                                              // router_007:sink_ready -> aes_s1_agent:rp_ready
	wire          aes_s1_agent_rp_startofpacket;                                                      // aes_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          aes_s1_agent_rp_endofpacket;                                                        // aes_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          aes_s1_agent_rdata_fifo_src_valid;                                                  // aes_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] aes_s1_agent_rdata_fifo_src_data;                                                   // aes_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          aes_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_005:in_0_ready -> aes_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> aes_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> aes_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // aes_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> aes_s1_agent:rdata_fifo_sink_error
